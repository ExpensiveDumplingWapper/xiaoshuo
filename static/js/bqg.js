...
if(/Android|Windows Phone|webOS|iPhone|iPod|BlackBerry/i.test(navigator.userAgent)){
    ...
    // if (url.match(/\/\/www\.xbiquge\.la\//)) { Go('https://wap.xbiquge.la/'); }

    // id = url.match(/\/\d+\/(\d+)\//);
    // if (id){Go('https://wap.xbiquge.la/wapbook/'+id[1]+'.html');}

    // id = url.match(/\/\d+\/(\d+)\/(\d+).html/);
    // if (id){Go('https://wap.xbiquge.la/wapbook/'+id[1]+'_' + id[2] + '.html');}
...
document.writeln("<div class=\"header_search\"><form name=\"form\" action=\"/book_search\" method=\"get\" id=\"sform\"><input type=\"text\" value=\"可搜书名和作者，请您少字也别输错字。\" name=\"searchkey\" class=\"search\" id=\"wd\" baiduSug=\"2\" /><button id=\"sss\" type=\"submit\"> 搜 索 </button></form></div>");
...
document.writeln("<div class=\"userpanel\">&nbsp;<font color=\"red\">留言：</font><a rel=\"nofllow\" href=\"/ask_book_html\" rel=\"nofllow\" ><font color=\"red\">求书加书</font></a>、<a rel=\"nofllow\" href=\"/leave_message_html\" >意见反馈</a><br /></div>");
